...
struct OpenLibraryIntent: AppIntent {
    ...
    static var description: IntentDescription = "Opens a Plex library in Slingshot"
...
extension Notification.Name {
    static let siriOpenLibrary = Notification.Name("slingshot.siri.openLibrary")
    static let siriPlayQueue = Notification.Name("slingshot.siri.playQueue")
}
