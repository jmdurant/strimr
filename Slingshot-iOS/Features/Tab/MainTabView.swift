...
struct MainTabView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: Notification.Name("slingshot.siri.openLibrary"))) { notification in
        ...
        .onReceive(NotificationCenter.default.publisher(for: Notification.Name("slingshot.siri.playQueue"))) { notification in
        ...
        .onReceive(NotificationCenter.default.publisher(for: Notification.Name("slingshot.player.finished"))) { _ in
            coordinator.resetPlayer()
        }
        .onReceive(NotificationCenter.default.publisher(for: Notification.Name("slingshot.livetv.finished"))) { _ in
